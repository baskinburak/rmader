...
class Rmader {
   public:
    using VectorDIM = Eigen::Vector3d;

    Rmader(mt::parameters par);
    bool replan_with_delaycheck(mt::Edges& edges_obstacles_out,
   ...
   private:
    ...
    bool safetyCheckAfterOptForRmader(mt::PieceWisePol pwp_optimized,
                                      bool& is_q0_fail);
    ...
    bool trajsAndPwpAreInCollision_with_inflation(
        mt::dynTrajCompiled traj, mt::PieceWisePol pwp_optimized,
